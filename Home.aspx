<%@ Page Title="" Language="C#" MasterPageFile="~/MaskInc.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="Group_MaskInc_FrontEnd.WebForm3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="hero-slider">
        <div class="hero-items owl-carousel">
            <div class="single-slider-item set-bg" data-setbg="assets/img/Free_Sample_By_Wix (6).jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1>MaskInc.</h1>
            ...
            <div class="single-slider-item set-bg" data-setbg="IMG_0689.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                          <h1>MaskInc.</h1>
        ...
        <div class="portfolio">
            <div class="no-padding portfolio_container">
                ...
                <div class="col-md-3 col-sm-6  fashion logo">
                    <a href="Casual.aspx" class="portfolio_item">
                        <img src="box/img/portfolio/images (30).jpg" alt="image" class="img-responsive" />
                ...
                <div class="col-md-3 col-sm-6 ads graphics">
                    <a href="Kids.aspx" class="portfolio_item">
                        <img src="box/img/portfolio/images (32).jpg" alt="image" class="img-responsive" />
                        <div class="portfolio_item_hover">
                ...
                <div class="col-md-6 col-sm-12 photography">
                    <a href="Custom.aspx" class="portfolio_item">
                        <img src="box/img/portfolio/b5468acf-a8e3-4001-8391-0f888a093c4d.JPG" alt="image" class="img-responsive" />
                        <div class="portfolio_item_hover">
                            <div class="portfolio-border clearfix">
                                <div class="item_info">
                ...
                <div class="col-md-3 col-sm-6 graphics ads">
                    <a href="Cultural.aspx" class="portfolio_item">
                        <img src="img/portfolio/images (34).jpg" alt="image" class="img-responsive" />
                        <div class="portfolio_item_hover">
                            <div class="portfolio-border clearfix">
                                <div class="item_info">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <ul class="product-controls">
                            ...
                            <li data-filter=".Nano Range">Nano Range</li>
                            <li data-filter=".Cultural">Bags</li>
                            <li data-filter=".Customize">Customize</li>
            ...
            <div class="row" id="product-list">
                <div class="col-lg-3 col-sm-6 mix all dresses bags">
                    <div class="single-product-item">
                        <figure>
                            <a href="CheckOut.aspx"><img src="img/products/download (5).jpg" alt=""></a>
                ...
                <div class="col-lg-3 col-sm-6 mix all accesories bags">
                    <div class="single-product-item">
                        <figure>
                            <a href="CheckOut.aspx"><img src="img/products/images (5).jpg" alt=""></a>
                            <div class="p-status sale">sale</div>
                        </figure>
                        <div class="product-text">
                            <h6>ANC masks</h6>
                ...
                <div class="col-lg-3 col-sm-6 mix all dresses bags">
                    <div class="single-product-item">
                        <figure>
                            <a href="CheckOut.aspx"><img src="img/products/images (29).jpg" alt=""></a>
                        </figure>
                        <div class="product-text">
                            <h6>Printed masks</h6>
                            <p>R50/box</p>
                ...
                <div class="col-lg-3 col-sm-6 mix all accesories bags">
                    <div class="single-product-item">
                        <figure>
                            <a href="CheckOut.aspx"><img src="img/products/download (8).jpg00." alt=""></a>
                            <div class="p-status popular">popular</div>
                        </figure>
                        <div class="product-text">
                            <h6>Kids Nano Range</h6>
                            <p>R100/10masks</p>
                        </div>
                    </div>
                </div>
